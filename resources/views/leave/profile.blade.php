            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-content">
                        {{ Form::open(array('action' => 'profileController@index', 'method' => 'POST', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data')) }}
                            <div class="form-group">
                                <div class="col-lg-2">
                                    <div class="profile-image">
                                        <img src="{{ asset('storage/images/'. $profile->profile_picture) }}" />
                                ...
                                <div class="col-lg-10">
                                    <div class="form-group">
                                        <div class="col-lg-4">
                                            ...
                                            <div class="col-sm-8">
                                                {{ Form::text('lname', '', ['class' => 'form-control','id' => 'inputEmail3','placeholder' => $profile->lname,'required' => 'required']) }}
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            {{ Form::label('fname', 'First-Name:', ['class' => 'col-sm-4 control-label']) }}
                                            <div class="col-sm-8">
                                                {{ Form::text('fname', '', ['class' => 'form-control','id' => 'inputEmail3','placeholder' => $profile->fname, 'readonly']) }}
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            {{ Form::label('oname', 'Other-Name:', ['class' => 'col-sm-4 control-label']) }}
                                            <div class="col-sm-8">
                                                {{ Form::text('oname', '', ['class' => 'form-control','id' => 'inputEmail3','placeholder' => $profile->oname, 'readonly']) }}
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <div class="col-sm-8">
                                                {{ Form::select('department', ['Select Department'] + array('check','check2'), '', ['class' => 'form-control m-b', 'id' => 'department']) }}
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            {{ Form::label('unit', 'Unit:',['class' => 'col-sm-4 control-label']) }}   
                                            <div class="col-sm-8">
                                                {{ Form::select('unit',['Select Unit'] + array('check','check2'),'', ['class' => 'form-control m-b']) }}
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
